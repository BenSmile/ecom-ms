 ...
 */
@Generated
public class ProductRepository__TestContext001_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getProductRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ProductRepository.class, MicroservModelProduct.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.vodacomtraining.demo.Repository.ProductRepository");
