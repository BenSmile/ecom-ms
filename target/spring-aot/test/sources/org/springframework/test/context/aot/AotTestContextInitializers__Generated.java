...
import com.vodacomtraining.demo.OrderandproductsApplicationTests__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.vodacomtraining.demo.OrderandproductsApplicationTests", () -> new OrderandproductsApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.vodacomtraining.demo.OrderandproductsApplicationTests", OrderandproductsApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
