...
import com.vodacomtraining.demo.MicroservController.MicroservController__BeanDefinitions;
import com.vodacomtraining.demo.MicroservController.OrderController__BeanDefinitions;
import com.vodacomtraining.demo.MicroservService.MicroservService__BeanDefinitions;
import com.vodacomtraining.demo.MicroservService2.OrderService__BeanDefinitions;
import com.vodacomtraining.demo.Repository.OrderRepository__BeanDefinitions;
import com.vodacomtraining.demo.Repository.ProductRepository__BeanDefinitions;
...
import org.springframework.boot.autoconfigure.amqp.RabbitAnnotationDrivenConfiguration__BeanDefinitions;
import org.springframework.boot.autoconfigure.amqp.RabbitAutoConfiguration__BeanDefinitions;
import org.springframework.boot.autoconfigure.amqp.RabbitProperties__BeanDefinitions;
 ...
 */
@Generated
public class OrderandproductsApplication__BeanFactoryRegistrations {
  /**
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("orderandproductsApplication", OrderandproductsApplication__BeanDefinitions.getOrderandproductsApplicationBeanDefinition());
    beanFactory.registerBeanDefinition("microservController", MicroservController__BeanDefinitions.getMicroservControllerBeanDefinition());
    beanFactory.registerBeanDefinition("orderController", OrderController__BeanDefinitions.getOrderControllerBeanDefinition());
    beanFactory.registerBeanDefinition("microservService", MicroservService__BeanDefinitions.getMicroservServiceBeanDefinition());
    beanFactory.registerBeanDefinition("orderService", OrderService__BeanDefinitions.getOrderServiceBeanDefinition());
    beanFactory.registerBeanDefinition("restTemplate", OrderandproductsApplication__BeanDefinitions.getRestTemplateBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springframework.boot.autoconfigure.amqp.RabbitAutoConfiguration$RabbitConnectionFactoryCreator", RabbitAutoConfiguration__BeanDefinitions.RabbitConnectionFactoryCreator.getRabbitConnectionFactoryCreatorBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springframework.boot.autoconfigure.amqp.RabbitAutoConfiguration$RabbitTemplateConfiguration", RabbitAutoConfiguration__BeanDefinitions.RabbitTemplateConfiguration.getRabbitTemplateConfigurationBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springframework.boot.autoconfigure.amqp.RabbitAutoConfiguration$MessagingTemplateConfiguration", RabbitAutoConfiguration__BeanDefinitions.MessagingTemplateConfiguration.getMessagingTemplateConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("rabbitMessagingTemplate", RabbitAutoConfiguration__BeanDefinitions.MessagingTemplateConfiguration.getRabbitMessagingTemplateBeanDefinition());
    beanFactory.registerBeanDefinition("org.springframework.boot.autoconfigure.amqp.RabbitAnnotationDrivenConfiguration$EnableRabbitConfiguration", RabbitAnnotationDrivenConfiguration__BeanDefinitions.EnableRabbitConfiguration.getEnableRabbitConfigurationBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springframework.boot.autoconfigure.amqp.RabbitAnnotationDrivenConfiguration", RabbitAnnotationDrivenConfiguration__BeanDefinitions.getRabbitAnnotationDrivenConfigurationBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springframework.boot.autoconfigure.amqp.RabbitAutoConfiguration", RabbitAutoConfiguration__BeanDefinitions.getRabbitAutoConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("spring.rabbitmq-org.springframework.boot.autoconfigure.amqp.RabbitProperties", RabbitProperties__BeanDefinitions.getRabbitPropertiesBeanDefinition());
