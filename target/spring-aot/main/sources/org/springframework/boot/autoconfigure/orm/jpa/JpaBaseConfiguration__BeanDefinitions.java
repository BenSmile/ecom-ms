...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.vodacomtraining.demo.MicroservModel.MicroservModelProduct", "com.vodacomtraining.demo.MicroservModel.Order", "com.vodacomtraining.demo.MicroservModel.OrderItem");
