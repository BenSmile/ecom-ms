...
public class RabbitAutoConfiguration__BeanDefinitions {
  ...
  public static class RabbitConnectionFactoryCreator {
    ...
    private static BeanInstanceSupplier<RabbitConnectionDetails> getRabbitConnectionDetailsInstanceSupplier(
      ...
      return BeanInstanceSupplier.<RabbitConnectionDetails>forFactoryMethod(RabbitAutoConfiguration.RabbitConnectionFactoryCreator.class, "rabbitConnectionDetails")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean(RabbitAutoConfiguration.RabbitConnectionFactoryCreator.class).rabbitConnectionDetails());
    }
